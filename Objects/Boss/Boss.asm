...
; ---------------------------------------------------------------------------
; Áîññ àòàêóåò ñ ïîìîùüþ ïàäàþùåãî øàðà
; ---------------------------------------------------------------------------
...
+		move.l	d0,$34(a0)
		...
		jmp	(CreateChild6_Simple).w
; ---------------------------------------------------------------------------
; Áîññ àòàêóåò ñ ïîìîùüþ öèðêóëèðóþùèõ øàðîâ
; ---------------------------------------------------------------------------
...
BossRobot_MoveCircularChaseBall_Move:
		...
		tst.w	x_vel(a0)
		bpl.s	+
		addi.w	#$40,d0			; Ïðîâåðèòü ëåâóþ ñòîðîíó
		cmp.w	x_pos(a0),d0
		bhs.s	++
		bra.s	+++
+		addi.w	#$100,d0		; Ïðîâåðèòü ïðàâóþ ñòîðîíó
		cmp.w	x_pos(a0),d0
		bhs.s	++
+		neg.w	x_vel(a0)
+		rts
; ---------------------------------------------------------------------------
; Áîññ àòàêóåò ñ ïîìîùüþ îòòàëêèâàþùèõñÿ øàðîâ
; ---------------------------------------------------------------------------
...
BossRobot_SetPos:
		dc.w $40		; Ëåâàÿ ñòîðîíà
		dc.w $A0	; Ñåðåäèíà
		dc.w $100	; Ïðàâàÿ ñòîðîíà
		dc.w $A0	; Ñåðåäèíà
BossRobot_SetPos2:
		dc.w -$40	; Ëåâàÿ ñòîðîíà
		dc.w -$40	; Ñåðåäèíà
		dc.w $180	; Ïðàâàÿ ñòîðîíà
		dc.w $180	; Ñåðåäèíà
BossRobot_SetPos3:
		dc.w $40		; Ëåâàÿ ñòîðîíà
		dc.w $40		; Ñåðåäèíà
...
FallingWaitBall_Explosion:
		...
		jmp	(CreateChild6_Simple).w
; ---------------------------------------------------------------------------
; Âðàùàþùèéñÿ è ïðåñëåäóþùèé øàð
; ---------------------------------------------------------------------------
...
RepulsionBall_CheckWall:
		...
		tst.w	y_vel(a0)
		bmi.s	+
		addi.w	#$C8,d0			; Ïðîâåðèòü ïîë
		cmp.w	y_pos(a0),d0
		blo.s		++
		bra.s	+++
+		addi.w	#$18,d0			; Ïðîâåðèòü ïîòîëîê
		cmp.w	y_pos(a0),d0
		blo.s		++
+		neg.w	y_vel(a0)
...
+		move.w	(Camera_X_pos).w,d0
		tst.w	x_vel(a0)
		bpl.s	+
		addq.w	#8,d0			; Ïðîâåðèòü ëåâóþ ñòîðîíó ñòåíû
		cmp.w	x_pos(a0),d0
		bhs.s	++
		rts
+		addi.w	#$138,d0		; Ïðîâåðèòü ïðàâóþ ñòîðîíó ñòåíû
		cmp.w	x_pos(a0),d0
		bhs.s	++
+		neg.w	x_vel(a0)
		sfx	sfx_Laser5,0,0,0
...
ShootingBall_Shoot:
		...
		jmp	(CreateChild6_Simple).w
; ---------------------------------------------------------------------------
; Âîëíà ïåðåä íà÷àëîì ñòðåëüáû øàðîâ ïî ðàäèóñó
; ---------------------------------------------------------------------------
...
ShootingBall_Wave_Falling:
		...
		rts
; ---------------------------------------------------------------------------
; Ñíàðÿä äëÿ âûñòðåëà ïî ðàäèóñó
; ---------------------------------------------------------------------------
...
FallingWaitBall_Waiting2:
		...
		rts
; ---------------------------------------------------------------------------
; Ïðèöåë äëÿ âðàùàþùåãîñÿ è ïðåñëåäóþùåãî øàðà
; ---------------------------------------------------------------------------
...
MultiplyingBall_Create:
		...
		jmp	(CreateChild6_Simple).w
; ---------------------------------------------------------------------------
; Äîïîëíèòåëüíûé óìíîæàþùèéñÿ øàð
; ---------------------------------------------------------------------------
