...
BossGreyBall_DeadZone:
		...
		cmp.w	d0,d3
		bhs.s	BossGreyBall_CheckFireShield_Return
		lea	(Player_1).w,a1		; Äîâîëüíî çàñòðåâàòü!
		bra.w	sub_24280		; Ïîëó÷àé!
...
; ---------------------------------------------------------------------------
; Áîññ àòàêóåò ñ ïîìîùüþ âçðûâàþùèõñÿ øèïàñòûõ øàðîâ
; ---------------------------------------------------------------------------
...
+		rts
; ---------------------------------------------------------------------------
; Áîññ àòàêóåò ñ ïîìîùüþ øèïàñòîé ðóêè
; ---------------------------------------------------------------------------
...
BossGreyBall_MoveSpikeBall_Hand_Return:
		...
		rts
; ---------------------------------------------------------------------------
; Áîññ àòàêóåò ñ ïîìîùüþ øèïàñòûõ øàðîâ íà öåïè
; ---------------------------------------------------------------------------
...
BossGreyBall_SecondPhase_Intro_Return:
		rts
; ---------------------------------------------------------------------------
; Áîññ àòàêóåò ñ ïîìîùüþ ïðûæêà (âòîðàÿ ôàçà)
; ---------------------------------------------------------------------------
...
BossGreyBall_ThirdPhase_Intro_SkipIntro:
		...
		rts
; ---------------------------------------------------------------------------
; Áîññ àòàêóåò â âîçäóõå (òðåòüÿ ôàçà)
; ---------------------------------------------------------------------------
...
BossGreyBall_Spark_Draw:
		...
		jmp	(Sprite_CheckDeleteXY).w
; ---------------------------------------------------------------------------
; Àòàêóþùèé øèïàñòûé øàð (ðóêà) (ïåðâàÿ è òðåòüÿ ôàçà)
; ---------------------------------------------------------------------------
...
BossGreyBall_SpikeBall_Bounced_Jump:
		...
		jmp	(CreateChild6_Simple).w
; ---------------------------------------------------------------------------
; Òåíü îòñêàêèâàþùåãî øèïàñòîãî øàðà
; ---------------------------------------------------------------------------
...
BossGreyBall_SpikeBall_Bounced_Chain_Trail_CheckParent:
		jmp	(Child_CheckParent).w
; ---------------------------------------------------------------------------
; Âûñòðåëèâàþùèé øèïàñòûé øàð (âòîðàÿ è òðåòüÿ ôàçà)
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
; Öåïü âûñòðåëèâàþùåãî øèïàñòîãî øàðà
; ---------------------------------------------------------------------------
